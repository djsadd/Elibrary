...
dict.kk.auth = {
  ...
  login: {
    ...
    platonusButton: "Platonus арқылы кіру",
    platonusTitle: "Platonus арқылы кіру",
    platonusSubtitle: "Platonus тіркелгі деректерін пайдаланыңыз",
    platonusLoginLabel: "Platonus логині",
    platonusLoginPlaceholder: "Platonus логинін енгізіңіз",
    platonusPasswordLabel: "Platonus құпиясөзі",
    platonusPasswordPlaceholder: "Platonus құпиясөзін енгізіңіз",
