...
dict.en.admin.menu = {
  ...
  filters: {
    ...
    levelSortAsc: 'From top level',
    levelSortDesc: 'From nested level',
    perPage: 'Per page',
  },
  pagination: {
...
dict.ru.admin.menu = {
  ...
  filters: {
    ...
    levelSort: 'Сортировка по уровню',
    levelSortAsc: 'Сначала верхний уровень',
    levelSortDesc: 'Сначала вложенные',
    perPage: 'На странице',
  },
  pagination: {
...
dict.kk.admin.menu = {
  ...
  filters: {
    ...
    levelSort: 'Деңгей бойынша сұрыптау',
    levelSortAsc: 'Алдымен жоғарғы деңгей',
    levelSortDesc: 'Алдымен ішкі деңгей',
    perPage: 'Бір бетте',
  },
  pagination: {
...
dict.en.admin.pages = {
  ...
  fields: {
    ...
    summaryKk: 'Summary (KK)',
    summaryEn: 'Summary (EN)',
    status: 'Status',
    content: 'Page content',
    contentDefault: 'Default content',
...
dict.ru.admin.pages = {
  ...
  fields: {
    ...
    summaryKk: 'Краткое описание (KK)',
    summaryEn: 'Краткое описание (EN)',
    status: 'Статус',
    content: 'Содержимое страницы',
    contentDefault: 'Базовое содержимое',
    contentRu: 'Содержимое (RU)',
    contentKk: 'Содержимое (KK)',
    contentEn: 'Содержимое (EN)',
  },
};
...
dict.kk.admin.pages = {
  ...
  fields: {
    ...
    titleEn: 'Атауы (EN)',
    slug: 'Slug',
    menuItem: 'Мәзір тармағы',
    summary: 'Қысқаша сипаттама',
    summaryRu: 'Қысқаша сипаттама (RU)',
    summaryKk: 'Қысқаша сипаттама (KK)',
    summaryEn: 'Қысқаша сипаттама (EN)',
    status: 'Күйі',
    content: 'Бет мазмұны',
    contentDefault: 'Негізгі мазмұн',
    contentRu: 'Мазмұн (RU)',
    contentKk: 'Мазмұн (KK)',
    contentEn: 'Мазмұн (EN)',
  },
