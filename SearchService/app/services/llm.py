...
def _build_prompt(book: BookDoc, student_query: str | None, student_profile: StudentProfile | None) -> str:
    ...
    return (
        ...
        "Объясни на русском языке, почему именно эта книга полезна именно этому студенту. "
        "Ответ должен быть персонализированным, но без выдумывания фактов. "
        "Если данных мало, честно опирайся только на запрос, профиль и метаданные книги. "
        "Длина: 2-4 предложения, без markdown и списков.\n\n"
