...
class ContentPage(Base):
    ...
    menu_title_ru: Mapped[str | None] = mapped_column(String(255))
    menu_title_kk: Mapped[str | None] = mapped_column(String(255))
    menu_title_en: Mapped[str | None] = mapped_column(String(255))
    summary: Mapped[str | None] = mapped_column(Text)
    summary_ru: Mapped[str | None] = mapped_column(Text)
    summary_kk: Mapped[str | None] = mapped_column(Text)
    summary_en: Mapped[str | None] = mapped_column(Text)
    content_html: Mapped[str | None] = mapped_column(Text)
    content_html_ru: Mapped[str | None] = mapped_column(Text)
    content_html_kk: Mapped[str | None] = mapped_column(Text)
    content_html_en: Mapped[str | None] = mapped_column(Text)
